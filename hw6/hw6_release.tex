	...
	\begin{enumerate}
	    \item 
            \begin{enumerate}[start = 3]
                \item
                    $$\includegraphics[width = 0.5 \linewidth]{hw6/img_output/2.1b-i.png} \includegraphics[width = 0.5 \linewidth]{hw6/img_output/2.1b-ii.png}$$
                    $$\includegraphics[width = 0.5 \linewidth]{hw6/img_output/2.1b-iii.png} \includegraphics[width = 0.5 \linewidth]{hw6/img_output/2.1b-iv.png}$$
